    ...
    <div className="w-full flex md:justify-center justify-between items-center flex-col p-4 gradient-bg-footer-market mt-80">
      <div className="w-full flex sm:flex-row flex-col justify-between items-center my-4">
        <div className="flex flex-1 justify-center items-center flex-wrap sm:mt-0 mt-5 w-full">
          <a
            target="_blank"
            href="https://www.facebook.com/crvycmplms/"
            rel="noreferrer"
          >
            <TiSocialFacebookCircular
              fontSize={40}
          ...
          <a
            target="_blank"
            href="https://twitter.com/snippingto0l"
            rel="noreferrer"
          >
            <TiSocialTwitterCircular
              fontSize={40}
          ...
          <a
            target="_blank"
            href="https://www.instagram.com/carveylamosao/"
            rel="noreferrer"
          >
            <TiSocialInstagramCircular
              fontSize={40}
          ...
          <a
            target="_blank"
            href="https://github.com/Snipping-Tool"
            rel="noreferrer"
          >
            <TiSocialGithubCircular
              fontSize={40}
        ...
        <TiSocialGooglePlusCircular fontSize={40} className="text-white cursor-pointer hover:text-pink-700 transition hover:duration-700" />
          ...
          <a
            target="_blank"
            href="https://www.linkedin.com/in/crvycrvy/"
            rel="noreferrer"
          >
            <TiSocialLinkedinCircular
              fontSize={40}
